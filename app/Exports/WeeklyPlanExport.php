...
class WeeklyPlanExport implements FromCollection, WithHeadings, WithTitle, WithStyles, WithColumnFormatting
{
        ...
        try {
            foreach ($weekly_plan->tasks as $task) {
                ...
                $rows->push([
                    ...
                    'HORA RENDIMIENTO REAL' => ($task->end_date) ? $performace * $task->employees->count()   : '',
